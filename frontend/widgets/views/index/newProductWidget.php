                            ...
                            <div class="products">
                                <div class="product">       
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="<?= Url::to(['product/view', 'slug' => $value['slug']]) ?>"><img id="img_<?= $value->id ?>" src="<?= Yii::$app->homeUrl.$value->image ?>" data-echo="<?= Yii::$app->homeUrl.$value->image ?>" alt="<?= $value->title ?>" width="98%"></a>
                                        </div><!-- /.image -->          
                                    ...
                                    <div class="product-info text-left">
                                        ...
                                        <div class="product-price"> 
                                            <span class="price" id="txtPrice_<?= $value->id ?>">
                                                <?= number_format($value->price_sales,0,'.',',') ?> VNĐ            </span>
                                                <span class="price-before-discount">$ <?= number_format($value->price,0,'.',',') ?></span>
                                            </div><!-- /.product-price -->
                                        </div><!-- /.product-info -->
