...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
  ...
  <div class="tab-content">
   <div class="tab-pane active m-t-20" id="popular">
    ...
    <?php foreach ($dataPro as $value): ?>
      
    
    <div class="blog-post inner-bottom-30 " >
      <img class="img-responsive" src="<?= Yii::$app->homeurl;?>vender/images/blog-post/sm1.jpg" alt="">
      <h4><a href="blog-details.html"><?= $value['pro_name'] ?></a></h4>
      <span class="author"><?= $value['user_id'] ?></span>
      <span class="review">6 Comments</span>
      <span class="date-time"><?= date('d/m/Y H:i', $value['updated_at']); ?></span>
      <p class="description"><?= $value['short_introduction'] ?></p>
    </div>
    <?php endforeach ?>
    <div class="blog-post" >
