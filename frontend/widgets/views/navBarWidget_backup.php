<div class="header-nav animate-dropdown">
   <div class="container">
      <div class="yamm navbar navbar-default" role="navigation">
         <div class="navbar-header"> <button data-target="#mc-horizontal-menu-collapse" data-toggle="collapse" class="navbar-toggle collapsed" type="button"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> </div>
               ...
               <div class="nav-outer">
                  <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                           <li>
                              <div class="yamm-content">
                                             ...
                                             <div class="col-md-12">
                                                <div class="col-sm-6 col-md-6">
                                                   <div class="wide-banner cnt-strip">
                                                      <div class="image"> <img class="img-responsive" data-echo="<?= Yii::$app->homeUrl ?>vender/images/banners/4.jpg" src="<?= Yii::$app->homeUrl ?>vender/images/blank.gif" alt=""> </div>
                                                      <div class="strip">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                   <div class="wide-banner cnt-strip">
                                                      <div class="image"> <img class="img-responsive" data-echo="<?= Yii::$app->homeUrl ?>vender/images/banners/5.jpg" src="<?= Yii::$app->homeUrl ?>vender/images/blank.gif" alt=""> </div>
                                                      <div class="strip">
                                 ...
                                 <!-- /.wide-banners --> <!-- ============================================== WIDE PRODUCTS : END ============================================== --> 
                              </div>
                              <!-- /.yamm-content --> 
                           </li>
                        </ul>
                     ...
                     <li class="dropdown yamm">
                        <a href="<?= Yii::$app->homeUrl ?>product/listproduct/1" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Desktop</a> 
                        <ul class="dropdown-menu">
                           <li>
                              <div class="yamm-content">
                                 <div class="row">
                                    <div class='col-sm-12'>
                                       <div class="col-xs-12 col-sm-12 col-md-4">
                                          ...
                                          <ul class="links">
                                             <li><a href="<?= Yii::$app->homeUrl ?>product/listproduct/1">Power Supplies Power</a></li>
                                             <li><a href="<?= Yii::$app->homeUrl ?>product/listproduct/2">Power Supply Testers Sound </a></li>
                     ...
                     <li class="dropdown"> <a href="category.html">Electronics <span class="menu-label hot-menu hidden-xs">hot</span> </a> </li>
                     <li class="dropdown hidden-sm"> <a href="category.html">Television <span class="menu-label new-menu hidden-xs">new</span> </a> </li>
                     <li class="dropdown hidden-sm"> <a href="category.html">Smart Phone</a> </li>
