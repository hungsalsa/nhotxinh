...
<div class='col-md-9'>
   ...
   <div id="category" class="category-carousel hidden-xs">
      <div class="item">
         <div class="image">
            <img src="<?= Yii::$app->homeUrl?>vender/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
         </div>
         <div class="container-fluid">
            <div class="caption vertical-top text-left">
               <div class="big-text">
                     ...
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c1.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c2.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c3.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c4.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                              <div class="tag hot"><span>hot</span></div>
                           </div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c5.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                              <div class="tag sale"><span>sale</span></div>
                           </div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                     <div class="products">
                        <div class="product">
                           <div class="product-image">
                              <div class="image">
                                 <a href="detail.html"><img  src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c6.jpg" alt=""></a>
                              </div>
                              <!-- /.image -->			
                              <div class="tag new"><span>new</span></div>
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c1.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c2.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c3.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c4.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c5.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
                     ...
                     <div class="product-list product">
                        <div class="row product-list-row">
                           <div class="col col-sm-4 col-lg-4">
                              <div class="product-image">
                                 <div class="image">
                                    <img data-echo="<?= Yii::$app->homeUrl?>vender/images/products/c6.jpg" src="<?= Yii::$app->homeUrl?>vender/images/blank.gif" alt="">
                                 </div>
                              </div>
                              <!-- /.product-image -->
                           </div>
