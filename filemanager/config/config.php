...
$config = array(
	...
	*/
	...
	'access_keys' => array('dfc78fb912939b31a2798211ae7e950c'),
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../anh-lopxin/'), //fixed path of the image folder from the current position on upload folder
	/*
	'../anh-lopxin/' : anh danh sach san pham ngoai trang chu
	*/
	...
	'fixed_image_creation_width'              => array(189), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array(206), //height of image (you can leave empty if you set width)
	...
	#                          4 / crop= resize and crop;
	*/
	'fixed_image_creation_option'             => array( 'crop', 'crop', 'crop' ), //set the type of the crop
