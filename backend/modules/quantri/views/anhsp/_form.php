...
<div class="imgprolist-form">
    ...
    <?= $form->field($model, 'pro_id',['options' => ['class' => 'col-md-3']])->dropDownList($listPro,[ 'disabled' => 'disabled']) ?>
    <?= $form->field($model, 'image',['options' => ['class' => 'col-md-3']])->textInput(['maxlength' => true,'id'=>'imageFile','placeholder'=>'Chọn ảnh cỡ 317x346 pixel']) ?>
    ...
    <?php // $form->field($model, 'title',['options' => ['class' => 'col-md-3']])->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'alt',['options' => ['class' => 'col-md-3']])->textInput(['maxlength' => true]) ?>
...
<?php $this->registerJsFile("@web/js/main_image.js", ['depends' => [yii\web\JqueryAsset::className()]]); ?>