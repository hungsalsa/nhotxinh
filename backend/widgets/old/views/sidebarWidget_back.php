    	...
    	<ul class="nav">
            ...
            <li class="list-group">
                ...
                <div class="collapse" id="setting">
                    ...
                    <a href="<?= Yii::$app->homeUrl ?>quantri/manufactures" class="list-group-item menudropdown" data-parent="#setting">Nhà sản xuất</a>
                    <a href="<?= Yii::$app->homeUrl ?>quantri/product" class="list-group-item menudropdown" data-parent="#setting">Sản phẩm</a>
                </div>
            </li>
            <li>
