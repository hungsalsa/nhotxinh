            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="<?= Yii::$app->homeUrl ?>">
                        ...
                        <!--This is dark logo text--><img src="<?= Yii::$app->homeUrl ?>plugins/images/admin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="<?= Yii::$app->homeUrl ?>plugins/images/admin-text-dark.png" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a href="<?= Yii::$app->request->hostInfo ?>" target="_blank"><i class="icon-user-follow fa-fw"></i><span class="hide-menu">View Website</span></a>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="<?= Yii::$app->homeUrl ?>plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?= (isset(getUser()->id))? getUser()->username: 'Steave' ?></b><span class="caret"></span> </a>
