...
$config = array(
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../icon-san-pham/'), //fixed path of the image folder from the current position on upload folder
	...
	'fixed_image_creation_width'              => array( 68 ), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array( 75 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
